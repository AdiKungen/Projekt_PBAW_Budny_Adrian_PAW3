  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Podziękowania / Credits</h4>
      </div>
      <div class="modal-body text-left">
        <p><strong>Framework:</strong> <a href="https://amelia-framework.eu/" target="_blank">Amelia Framework</a> autorstwa Przemysława Kudłacika.</p>
